...
namespace EventStore.Core {
	...
	public abstract class VNodeBuilder {
		...
		/// </summary>
		/// <returns>A <see cref="VNodeBuilder"/> with the options set</returns>
		public VNodeBuilder ValidateSslMasterNode() {
			_sslValidateMasterNode = true;
			return this;
		}

		/// <summary>
		/// Sets whether to validate the slave node's certificate when this node is Master.
		/// </summary>
		/// <returns>A <see cref="VNodeBuilder"/> with the options set</returns>
		public VNodeBuilder ValidateSslSlaveNode() {
			_sslValidateSlaveNode = true;
			return this;
		}
